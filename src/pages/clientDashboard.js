...
function clientDashboard() {
  ...
  useEffect(() => {
    ...
    setPendingTickets(
      tickets.filter((ticket) => ticket.ticket_status === "pending")
    );
    setInvoiceTickets(
      tickets.filter(
        (ticket) => ticket.ticket_status.toLowerCase() === "invoice-approval"
      )
    );
  }, [tickets]);
        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: "16px" }}>
              {sortedData.length > 1 ? "tickets" : "ticket"}
            </div>
          ...
          >
            ...
            >
              {" "}
              {invoiceTickets.length}{" "}
            </div>
            <div style={{ fontSize: "16px" }}>
              {invoiceTickets.length > 1
      ...
      <div>
        ...
        <Modal.Body className="text-center" style={{ margin: "10px" }}>
          ...
          <p style={{ fontSize: "12px" }}>
            14th Floor, Buildcomm Center, Sumilon Road, Cebu Business Park
            <br />
